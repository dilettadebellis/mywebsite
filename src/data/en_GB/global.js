export const global = {
  ...
  heroHome: {
    im: "I'm",
    description:
      "Hello! I am an enthusiastic and passionate Web&Social Media\n" +
      "fanatic, specialized in the areas of branding, web\n" +
      "development, content creation, advertising and social media.",
    definition:
      "Web Marketing Specialist.,Social Media Strategist.,Digital Communication Consultant.",
    a: "A",
  },
  heroAbout: {
    cvInfo: {
